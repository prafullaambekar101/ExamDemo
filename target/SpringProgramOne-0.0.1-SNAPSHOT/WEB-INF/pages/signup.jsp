			...
			<div class="card ">
				...
				<div class="card-body">
					<div class="form-group">
						...
						<form:input type="text" class="form-control" placeholder="Enter user name" path="uname" />
					...
					<div class="form-group">
						...
						<form:input type="password" class="form-control" placeholder="Enter password" path="pass" />
